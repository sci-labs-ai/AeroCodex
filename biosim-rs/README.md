...
Chunk 6A, Chunk 6B, Chunk 6C, Chunk 6D, and Chunk 6E clean-room primitives are implemented in the existing life-support crate, not in this placeholder directory:
...
- `docs/assurance/biosim_rs_cli_api_smoke_friend_test_report.md`
...
- `validation/cards/life_support_biosim_rs_cli_api_smoke_friend_test_report.yaml`
...
- `validation/source_registry/life_support_biosim_rs_cli_api_smoke_clean_room.yaml`
...
Future code in this placeholder directory may only be added after a later chunk records source IDs, license path, validation status, broader replay evidence, persistent resource-ledger storage expectations, scenario evidence, persistent command-surface requirements, and the research/preliminary-design caveat. Chunk 6A, Chunk 6B, Chunk 6C, Chunk 6D, and Chunk 6E do not authorize adding crates or external-source material under `biosim-rs/`.
