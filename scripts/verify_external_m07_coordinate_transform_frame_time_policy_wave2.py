...
def self_test()->dict[str,Any]:
    ...
    if EXPECTED_CUMULATIVE_PROCESSED!=1305: errors.append('EXPECTED_CUMULATIVE_PROCESSED mismatch')
    if EXPECTED_REMAINING_BACKLOG!=18: errors.append('EXPECTED_REMAINING_BACKLOG mismatch')
