...
EXPECTED_CUMULATIVE_PROCESSED=538
EXPECTED_REMAINING_BACKLOG=785
...
def self_test()->dict[str,Any]:
    ...
    if EXPECTED_CUMULATIVE_PROCESSED!=538:errors.append('EXPECTED_CUMULATIVE_PROCESSED mismatch')
    if EXPECTED_REMAINING_BACKLOG!=785:errors.append('EXPECTED_REMAINING_BACKLOG mismatch')
