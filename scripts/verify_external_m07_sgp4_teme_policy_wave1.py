...
def self_test():
    require(len(SELECTED_LOCATORS)==EXPECTED_ROWS,'self selected count mismatch'); require(EXPECTED_CUMULATIVE_PROCESSED==1125,'processed counter mismatch'); require(EXPECTED_REMAINING_BACKLOG==198,'backlog counter mismatch')
