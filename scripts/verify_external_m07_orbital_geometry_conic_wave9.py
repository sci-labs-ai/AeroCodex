...
def self_test()->dict[str,Any]:
    ...
    if EXPECTED_CUMULATIVE_PROCESSED!=521:errors.append('EXPECTED_CUMULATIVE_PROCESSED mismatch')
    if EXPECTED_REMAINING_BACKLOG!=802:errors.append('EXPECTED_REMAINING_BACKLOG mismatch')
