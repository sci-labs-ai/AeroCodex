...
FUTURE_SAME_POOL_RESOLUTION_PATHS={'formula-vault/resolutions/m07_classifier_refresh_manual_source_review_wave2.tsv', 'formula-vault/resolutions/m07_final_residual_backlog_closure_wave1.tsv'}
...
def self_test():
    require(len(SELECTED_LOCATORS)==EXPECTED_ROWS,'self selected count mismatch'); require(EXPECTED_CUMULATIVE_PROCESSED==1323,'processed counter mismatch'); require(EXPECTED_REMAINING_BACKLOG==0,'backlog counter mismatch')
