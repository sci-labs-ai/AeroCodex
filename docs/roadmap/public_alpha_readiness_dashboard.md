...
| External M07 rows with terminal dispositions | 241 | A11-A17 record 120 aliases, 38 excluded internal helpers, and 83 contract-blocked rows. |
...
- A11-A17 resolve seven bounded metadata waves: 120 aliases reuse existing governed runtimes, 38 internal/composite helpers are excluded from formula scope, and 83 rows remain contract-blocked. A14-A15 complete all 49 classical two-body algebra rows; A16-A17 process the first 80 orbital-geometry/conic rows and leave 297 rows in that classifier group. A17 retains 38 medium-risk and 2 high-risk labels, and the remaining 1,082-row external backlog is incomplete.
