...
| `python scripts/verify_governance.py --repo .` | exits successfully | Formula-vault runtime resolutions, A11-A16 external dispositions, and the configured xtask governance verifiers completed as a group. |
