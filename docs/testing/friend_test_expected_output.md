...
| `python scripts/verify_governance.py --repo .` | exits successfully | Formula-vault runtime resolutions, A11-A28 external dispositions, and the configured xtask governance verifiers completed as a group. |
...
| External M07 rows with terminal dispositions | 663 | A11-A28 record 127 aliases, 103 excluded internal/composite helpers, and 433 contract- or policy-blocked rows. |
