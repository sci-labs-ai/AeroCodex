...
| BioSim v3 B2c | Replay-integrity, ledger/report, synthetic example, and governance | deployed/completed | needs_review | deployed by this bounded B2c change | Consumes B2b-2 replay records directly; B2b-3 adapter is skipped/not required for this path; no flat-resource adapter, full engine, controller, biological-fidelity, habitat-safety, medical, operational, parity, certification, or regulated-use claim. |
