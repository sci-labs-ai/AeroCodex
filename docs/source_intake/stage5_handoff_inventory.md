...
| BioSim v3 B2b-1 | Process types, validated constructors, and deterministic one-tick intent planner | deployed/completed | needs_review | this bounded B2b-1 deployment commit | No scenario-state mutation, replay, adapter, ledger, report, example, digest, full engine, controller, biological-fidelity, habitat-safety, medical, operational, parity, or certification claim. |
...
| BioSim v3 B2b | `BioSim v3 B2b process/replay adapter patch` | `10561209f926016ae1cc8d2bf8ab559945d3ed2002c2f64285051fe5b276de3f` | 84569 | blocked | Monolithic patch remains blocked as a direct deploy target; B2b-1 was re-cut and deployed as process/planner foundation only. |
...
- Corrected BioSim B2a is deployed only as scenario-domain/structural-validation foundation; B2b-1 is deployed only as process/validated-constructor/one-tick-intent-planning foundation; B2b-2, B2b-3, and B2c remain unstarted by B2b-1.
