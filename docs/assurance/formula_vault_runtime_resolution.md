...
- A11-A21 assign terminal dispositions to 401 external rows; 922 external M07 rows remain unprocessed and incomplete. A12-A13 complete the 74-row vector-helper group with 56 aliases, 13 internal shape-helper exclusions, and 5 contract-blocked rows. A14-A15 complete the 49-row classical two-body algebra group with 22 aliases and 27 contract blocks. A16-A21 process the first 240 orbital-geometry/conic rows with 10 aliases, 63 helper exclusions, and 167 contract or policy blocks. A21 retains 18 medium-risk and 22 high-risk labels; these waves do not downgrade classifier risk tiers.
